...
DROP DATABASE IF EXISTS webacademy;
CREATE DATABASE webacademy CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE webacademy;
...
(
    'e7f41431-2e76-4a57-9c42-95a0da420aaf',
...
INSERT INTO livros (id, nome, sinopse, isbn, autores, url_imagem) VALUES
(
    'e1a4446f-f21a-4081-a321-835c29cd2a78',
...
INSERT INTO livros (id, nome, sinopse, isbn, autores, url_imagem) VALUES
(
    'b48124b4-c870-4b7f-844c-4270365dc381',
...
INSERT INTO livros (id, nome, sinopse, isbn, autores, url_imagem) VALUES
(
    '1fd26b05-e791-48ab-8413-eb5ca13c9be0',
...
INSERT INTO livros (id, nome, sinopse, isbn, autores, url_imagem) VALUES
(
    'ad79e3a1-8fde-482d-b573-ce9108e6e188',
