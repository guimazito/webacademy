...
describe("primeiroNome(nomeCompleto)", () => {
  ...
  it("deve retornar o primeiro nome composto quando houver hífen", () => {
    expect(primeiroNome("Cláudio-Albano Guimarães")).toBe("Cláudio-Albano");
  });
  ...
  it("deve retornar string vazia se o nome só possuir espaços vazios", () => {
    expect(primeiroNome("   ")).toBe("");
  });

  it("deve retornar string vazia se o nome for null", () => {
    expect(primeiroNome(null)).toBe("");
  });

  it("deve retornar string vazia se o nome for undefined", () => {
    expect(primeiroNome(undefined)).toBe("");
  });

  it("deve retornar string vazia se o nome for diferente de string", () => {
    expect(primeiroNome(123)).toBe("");
    expect(primeiroNome({})).toBe("");
  });
});
